        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TosId = table.Column<int>(type: "int", nullable: false),
                    Accepted = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppUserToss", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActivityLevel = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AppUserId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    CarbPreference = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Diets", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Diets_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PfAccountId = table.Column<int>(type: "int", nullable: false),
                    DailyCals = table.Column<int>(type: "int", nullable: false),
                    DailyProtien = table.Column<int>(type: "int", nullable: false),
                    DailyFat = table.Column<int>(type: "int", nullable: false),
                    DailyCarbs = table.Column<int>(type: "int", nullable: false),
                    Date = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DailyDiets", x => x.DailyDietId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Diets_AppUserId",
                table: "Diets",
                column: "AppUserId");

            migrationBuilder.AddForeignKey(
                name: "FK_AspNetUsers_AppUserSettings_SettingId",
                table: "AspNetUsers",
                column: "SettingId",
                principalTable: "AppUserSettings",
                principalColumn: "Id",
                onDelete: ReferentialAction.Cascade);
        }
