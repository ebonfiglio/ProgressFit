...
namespace ProgressFit.Data.Migrations
{
    ...
    [Migration("20221217233929_SessionEntitiesNameFix")]
    partial class SessionEntitiesNameFix
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProgressFit.Shared.Entities.Session", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ProgressFit.Shared.Entities.SessionExercise", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ProgressFit.Shared.Entities.Session", b =>
                {
                    b.HasOne("ProgressFit.Shared.Entities.Routine", "Routine")
                        .WithMany()
                        .HasForeignKey("RoutineId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ProgressFit.Shared.Entities.Workout", "Workout")
                        .WithMany()
                        .HasForeignKey("WorkoutId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ProgressFit.Shared.Entities.SessionExercise", b =>
                {
                    ...
                    b.HasOne("ProgressFit.Shared.Entities.Session", "Session")
            ...
            modelBuilder.Entity("ProgressFit.Shared.Entities.Set", b =>
                {
                    b.HasOne("ProgressFit.Shared.Entities.SessionExercise", null)
                        .WithMany("Sets")
